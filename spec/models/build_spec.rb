...
describe Build do
  ...
  context "#analyze" do
    ...
    it "should fetch remote git and analyze" do
      ...
      RailsBestPractices::Analyzer.expects(:new).with(path, format: "html", silent: true, "output-file" => path + "/rbp.html", "with-github" => true, "github-name" => "flyerhzm/railsbp.com", "only-table" => true).returns(rails_best_practices)
