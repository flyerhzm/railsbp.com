# RailsAdmin config file. Generated on February 03, 2013 19:52
...
RailsAdmin.config do |config|
  ...
  # config.included_models = ['Build', 'Category', 'Configuration', 'Parameter', 'Repository', 'User', 'UserRepository']
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your parameter.rb model definition
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your user_repository.rb model definition
